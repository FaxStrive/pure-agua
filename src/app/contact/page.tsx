...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Contact Us - Schedule a Free Water Test | Pure Agua",
    description: "Schedule your free in-home water test in Central Florida. Call (407) 512-8342.",
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          Flexible financing options are available for qualifying homeowners, including plans with zero percent introductory rates and no money down. Every system we install comes with a lifetime warranty on the control valve and tank, giving you peace of mind that your investment is protected. Do not wait to discover what is in your water. Contact Pure Agua Enterprises today at (407) 512-8342 and take the first step toward cleaner, healthier water for your entire home.
        </p>
      </div>
      <PageClient />
    </>
