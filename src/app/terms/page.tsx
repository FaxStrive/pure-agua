  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          If you opt in to receive SMS or text messages from Pure Agua Enterprises, you consent to receive service-related communications including appointment reminders, follow-up messages, and promotional offers. Message and data rates from your wireless carrier may apply. You may opt out of text messaging at any time by replying STOP to any message. Pure Agua Enterprises does not sell or share your phone number or personal information with third-party marketers. For questions about these terms, contact us at (407) 512-8342 or visit our Kissimmee office during business hours.
        </p>
      </div>
      <PageClient />
    </>
