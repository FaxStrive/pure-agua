...
export const metadata: Metadata = {
  title: "Privacy Policy for Website & SMS Users",
  description:
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          Our website may use cookies, analytics tools, and similar technologies to understand how visitors use our pages, improve site performance, and deliver relevant content. We implement reasonable security measures to protect your data against unauthorized access, alteration, or disclosure. For questions about this privacy policy or to request deletion of your personal information, contact Pure Agua Enterprises at (407) 512-8342 or visit our office in Kissimmee, Florida. This policy may be updated periodically to reflect changes in our practices or applicable regulations.
        </p>
      </div>
      <PageClient />
    </>
